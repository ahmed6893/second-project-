                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Edit Color Info</h4>
                        ...
                        <div class="card-body">
                            ...
                            <form class="form-horizontal" action="{{route('color.update',$color->id)}}" method="post" >
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="color" class="form-control" name="code" value="{{$color->code}}" placeholder="Enter Color Code">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label">Color Description</label>
                                    <div class="col-sm-10">
                                        <textarea class="form-control" name="description" placeholder="Enter Color Description">{{$color->desciption}}</textarea>
                                    </div>
                                </div>

                                <div class="form-group row">
                                    <div class="col-sm-10">
                                        <button type="submit" class="btn btn-primary">Update New Color</button>
                                    </div>
                                </div>
                            </form>
