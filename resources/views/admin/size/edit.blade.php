                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Edit Size Info</h4>
                        ...
                        <div class="card-body">
                            ...
                            <form class="form-horizontal" action="{{route('size.update',$size->id)}}" method="post">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="color" class="form-control" name="code" value="{{$size->code}}" placeholder="Enter Size Code">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label">Size Description</label>
                                    <div class="col-sm-10">
                                        <textarea class="form-control" name="description" placeholder="Enter Size Description">{{$size->desciption}}</textarea>
                                    </div>
                                </div>

                                <div class="form-group row">
                                    <div class="col-sm-10">
                                        <button type="submit" class="btn btn-primary">Update New Size</button>
                                    </div>
                                </div>
                            </form>
