                        ...
                        <div class="card-body">
                            ...
                            <form class="form-horizontal" action="{{route('product.store')}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea class="form-control" name="meta_title" placeholder="Enter Your Meta Title"></textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label">Meta Description</label>
                                    <div class="col-sm-10">
                                        <textarea class="form-control" name="meta_description" placeholder="Enter Your Meta Description"></textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group">
                                            <input class="form-control" type="number" name="regular_price" placeholder="Product Regular Price">
                                            <input class="form-control" type="number" name="selling_price" placeholder="Product Selling Price">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="number" class="form-control" name="stock_amount" placeholder="Enter Your Stock Amount">
                                    </div>
                                </div>
                                <div class="form-group row">
