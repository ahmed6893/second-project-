                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="profile__main-inner d-flex flex-wrap align-items-center">
                                                            ...
                                                            <div class="profile__main-content">
                                                                <h4 class="profile__main-title">Welcome {{$customer->name}}</h4>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-xxl-6 col-md-6">
                                                            <div class="profile__input-box">
                                                                <div class="profile__input">
                                                                    <input type="text" placeholder="Enter your username" value="{{$customer->name}}">
                                                                    <span>
                                                      <svg width="17" height="19" viewBox="0 0 17 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        ...
                                                        <div class="col-xxl-6 col-md-6">
                                                            <div class="profile__input-box">
                                                                <div class="profile__input">
                                                                    <input type="email" placeholder="Enter your email" value="{{$customer->email}}">
                                                                    <span>
                                                      <svg width="18" height="16" viewBox="0 0 18 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        ...
                                                        <div class="col-xxl-6 col-md-6">
                                                            <div class="profile__input-box">
                                                                <div class="profile__input">
                                                                    <input type="text" placeholder="Enter your number" value="{{$customer->phone}}">
                                                                    <span>
                                            ...
                                            <form action="#" method="post" enctype="multipart/form-data">
                                                ...
                                                <div class="row">
                                                    <div class="col-xxl-12">
                                                        <div class="tp-profile-input-box">
                                                            <div class="tp-contact-input">
                                                                <input name="old_password" id="old_pass" type="password">
                                                            </div>
                                                    ...
                                                    <div class="col-xxl-6 col-md-6">
                                                        <div class="tp-profile-input-box">
                                                            <div class="tp-profile-input">
                                                                <input name="confirm_new_password" id="con_new_pass" type="password">
                                                            </div>
                                                            <div class="tp-profile-input-title">
                                        ...
                                        <div class="profile__ticket table-responsive">
                                            <table class="table">
                                                ...
                                                <tr>
                                                    ...
                                                    <td data-info="title">{{$order->product_name}}</td>
                                                    <td data-info="status pending">{{$order->order_status}}</td>
                                                    <td><a href="#" class="tp-logout-btn">{{$order->order_date}}</a></td>
                                                </tr>
                                                @endforeach
                                                </tbody>
                                            </table>
