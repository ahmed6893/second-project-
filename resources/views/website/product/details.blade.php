                    ...
                    <form action="{{route('cart.store')}}" method="post">
                        ...
                        <div class="col-xl-5 col-lg-6">
                            <div class="tp-product-details-wrapper">
                                ...
                                <p>{{$product->short_description}}... <span>See more</span></p>
                                ...
                                <div class="tp-product-details-variation">
                                    ...
                                    <p class="" style="color: black">
                                        ...
                                        @foreach($product->productSizes as $key=> $productSize)
                                            <label class="me-2"><input type="radio" {{$key == 0 ? 'checked' : ''}} name="size" value="{{$productSize->size->name}}" />{{$productSize->size->name}}</label>
                                        @endforeach
                                </div>
                                    ...
                                    <div class="tp-product-details-action-item-wrapper d-flex align-items-center">
                                       ...
                                       <span class="tp-cart-minus">
                                        ...
                                        <div class="tp-product-details-add-to-cart mb-15 w-100">
                                            <button class="tp-product-details-add-to-cart-btn w-100" type="submit">Add To Cart</button>
                                        </div>
                                    </div>
