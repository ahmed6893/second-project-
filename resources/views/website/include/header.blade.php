                                ...
                                <a href="profile.html" class="d-flex align-items-center">
                                    ...
                                    <div class="tp-header-login-content d-none d-xl-block">
                                        @if(Session('customerId'))
                                            <span><a href="{{route('customer.logout')}}">Sign Out  |</a></span>
                                            <span><a href="">{{Session('customerName')}}</a></span>
                                        @else
                                            <span><a href="{{route('customer.login')}}">Sign In  |</a></span>
                                            <span><a href="{{route('customer.register')}}">Register</a></span>
                                        @endif
                                    </div>
                                ...
                                <nav class="tp-category-menu-content">
                                    <ul>
                                        ...
                                        <li class="has-dropdown">
                                            <a href="{{route('shofy',['id'=>$category->id])}}" class="has-mega-menu">
                                         <span>
                                            ...
                                            <ul class="tp-submenu tp-sub-category">
                                                @foreach($category->subCategory as $subCategory)
                                                <li><a href="{{route('sub-category-shofy',['id'=>$subCategory->id])}}">{{$subCategory->name}}</a></li>
                                                @endforeach
                                            </ul>
                                            @endif
                                        </li>
